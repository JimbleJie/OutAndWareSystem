...
<script type="text/javascript">
	function addrow() {
		...
		var addtr = $("<tr style='text-align: center;'>"
				+ "<td><input type='text' name='mtype'style='height: 100%; width: 95%; float: left;'placeholder='请输入种类'></td>"
				+ "<td><input type='text' name='mspec'style='height: 100%; width: 95%; float: left;'placeholder='请输入规格'></td>"
				+ "<td><input type='text' name='mweight'style='height: 100%; width: 95%; float: left;'placeholder='请输入理论重量'></td>"
				+ "</tr>");
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			...
			<form action="model.jsp?company=<%=company%>&email=<%=loginemail%>" method="post">
				<table border="1"
					...
					<tr style="text-align: center;">
						<td><input type="text" name="mtype"
							...
							placeholder="请输入种类"></td>
						<td><input type="text" name="mspec"
							style="height: 100%; width: 95%; float: left;"
							placeholder="请输入规格"></td>
						<td><input type="text" name="mweight"
							style="height: 100%; width: 95%; float: left;"
							placeholder="请输入理论重量"></td>
					</tr>
				</table>
				<!-- 提交按钮 -->
				<input type="submit"
