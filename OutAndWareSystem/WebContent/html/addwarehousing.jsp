<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@page
	import="com.owsys.bean.*,java.util.*,com.owsys.utils.*,java.sql.*,com.owsys.data.*"%>
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			...
			<!-- 列表展示 -->
			<form action="warehousing.jsp?company=<%=company%>&email=<%=loginemail%>" method="post">
				<table border="1"
					style="height: 100%; width: 80%; margin-left: 10%; margin-top: 5%"
					cellspacing="0" cellpadding="1" class="table">
					<tr>
						<th colspan="3" style="border: 0px">日期：<input type="text"
							name="wdate" style="height: 100%; width: 50%;"
							placeholder="请输入日期，格式：(20190101)">
						</th>
						<th colspan="3" style="border: 0px;">供货商：<select
							name="wsupname">
					...
					<tr style="text-align: center;">
						...
						<td><input type="text" name="wsweight"
							style="height: 100%; width: 95%; float: left;"
							placeholder="请输入单重"></td>
						<td><input type="text" name="wsprice"
							style="height: 100%; width: 95%; float: left;"
							placeholder="请输入单价"></td>
					</tr>
				</table>
				<!-- 提交按钮 -->
				<input type="submit"
