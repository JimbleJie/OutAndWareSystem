...
<script type="text/javascript">
	function addrow() {
		...
		var addtr = $("<tr style='text-align: center;'>"
				+ "<td><input type='text' name='cusname'style='height: 100%; width: 95%; float: left;'placeholder='请输入客户姓名'></td>"
				+ "<td><input type='text' name='custel'style='height: 100%; width: 95%; float: left;'placeholder='请输入客户电话'></td>"
				+ "<td><input type='text' name='cusunityname'style='height: 100%; width: 95%; float: left;'placeholder='请输入客户单位'></td>"
				+ "</tr>");
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			...
			<form action="customer.jsp?company=<%=company%>&email=<%=loginemail%>"
				method="post">
				<table border="1"
					...
					<tr style="text-align: center;">
						...
						<td><input type="text" name="custel"
							style="height: 100%; width: 95%; float: left;"
							placeholder="请输入客户电话"></td>
						<td><input type="text" name="cusunityname"
							style="height: 100%; width: 95%; float: left;"
							placeholder="请输入客户单位"></td>
					</tr>
				</table>
				<!-- 提交按钮 -->
				<input type="submit"
