...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@page import="com.hengdelian.bean.SupplierInfo,java.util.*"%>
...
<body>
	...
	<div style="height: 100px; width: 100%; margin-top: 100px">
		<h1 style="text-align: center;">添加供货商信息</h1>
	</div>
	<div style="height: 30px;width: 100%; margin-bottom: 50px">
		<img alt="" src="../img/zhiyuanfanhui.png" style="margin-left: 35%">
		<a href="../html/supplier.jsp"><strong>返回供货商界面</strong></a>
	</div>
	<!-- 信息添加 -->
	<form action="supplier.jsp" method="post">
		<div
			...
			<div
				...
				<input type="text" name="adsupname" placeholder="请输入供货商姓名"
			...
			<div
				...
				<img alt="" src="../img/danwei.png" style="margin-left: 5%"> <span
					...
					name="adsupunityname" placeholder="请输入供货商单位名称"
					style="height: 60%; width: 60%; float: right; margin-top: 1%; margin-right: 5%">
			</div>
			<!-- 手机号 -->
			<div
				...
				<span style="line-height: 50px">手&nbsp;&nbsp;机&nbsp;&nbsp;号</span> <input
					type="text" name="adsuptel" placeholder="请输入供货商手机号"
					style="height: 60%; width: 60%; float: right; margin-top: 1%; margin-right: 5%">
			</div>
			<!-- 提交按钮 -->
			<input type="submit"
